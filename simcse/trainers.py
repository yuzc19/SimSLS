...
class CLTrainer(Trainer):
    def evaluate(
        ...
        for example in eval_dataset:
            texts = [example["query_text"]] + [
                i[2] for i in example["processed_candidates"]
            ]
            pooler_output = None
            total = len(texts)
    ...
    def train(
        ...
        for epoch in range(epochs_trained, num_train_epochs):
            ...
            self._maybe_log_save_evaluate(tr_loss, model, trial, epoch)  # evaluate here
